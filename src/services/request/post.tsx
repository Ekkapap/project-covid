...
export default function callPost(api_url: string | undefined, endpoint: string, token?: string | null, payload?: any) {
    const headerOptions = { Authorization: `Bearer ${token}` };

    return (
        axios
            .post(api_url + endpoint, payload, { headers: headerOptions, timeout: 1000 })
            .then(
