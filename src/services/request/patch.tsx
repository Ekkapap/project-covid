...
export default function callPatch(api_url: string | undefined,endpoint: string, token?: string | null, payload?: any) {
    const headerOptions = { Authorization: `Bearer ${token}` };

    return (
        axios
            .patch(API + endpoint, payload, { headers: headerOptions, timeout: 1000 })
            .then(
