...
class diseaseRegion extends Component<IProps, IState> {
          ...
          <Row className='card-body' gutter={[0, { xs: 16, md: 8 }]}>
            ...
            <Col>
              <label className='fs14'>
                <Trans>pages.other_disease.table.desc</Trans>
              </label>
            </Col>
            ...
            <Col xs={24} md={24}>
              <ScreeningTable filter={this.state.filter} types={this.props.type} t={t} />
            </Col>
          </Row>
        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(diseaseRegion));
