...
class ScreeningByRegion extends Component<IProps, IState> {
  ...
  render() {
    ...
    const chartData = {
      ref: ref,
      name: t('pages.screening.chart.screeningRegion.name')
    };
    return (
      <div>
        <div ref={ref}>
          <Row className='card-body' gutter={[0, { xs: 16, md: 8 }]}>
            ...
            <Col>
              <label className='fs14'>
                <Trans>pages.screening.chart.screeningRegion.detail</Trans>
              </label>
              <br></br>
              <br></br>
              <br></br>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(ScreeningByRegion));
