...
class DeathWeekly extends Component<IProps, IState> {
    ...
    return (
      <div>
        <Row className='card-body' gutter={[0, { xs: 16, md: 8 }]}>
          <Col xs={24} md={12}>
            <label className='text-header'>เสียชีวิตจากโควิด-19 รายสัปดาห์</label>
          </Col>
          ...
          <Col xs={24} md={16}>
            <label className='fs14'>
              จำนวนผู้เสียชีวิตรายสัปดาห์ที่มีระบุว่า โควิด-19 เป็นหนึ่งในสาเหตุการเสียชีวิต
              โดยข้อมูลนี้จะแสดงเป็นรายทุกสัปดาห์ ข้อมูลจะยึดตามวันที่ผู้ป่วยเสียชีวิต
            </label>
          </Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(DeathWeekly);
