...
class VaccineDose2 extends Component<IProps, IState> {
  ...
  render() {
    ...
    const chartData = {
      ref: ref,
      name: t('pages.vaccine.chart.dose2.title'),
    };
    const config = {
      data: [getDataChart, getDataChart],
      xField: 'date',
      yField: ['dose2', 'weekly_dose2'],
      limitInPlot: false,
      slider: {},
      ...
      legend: {
        itemName: {
          formatter: (text: any, item: any) => {
            return item.value === 'dose2' ? 
              t("pages.vaccine.chart.dose2.bar") : 
              t("pages.vaccine.chart.dose2.line");
          },
        },
      },
      tooltip: {
        ...
        customContent: (title: string, items: any[]) => {
          ...
          return `
            <div class="custom-tooltip-item">${t('pages.vaccine.chart.dose2.tooltip.date')} : ${data.date}</div>
            <div class="custom-tooltip-item">${t('pages.vaccine.chart.dose2.tooltip.t1')} : ${data.dose1}</div>
            <div class="custom-tooltip-item">${t('pages.vaccine.chart.dose2.tooltip.t2')} : ${data.weekly_dose1}</div>`;
        },
      },
    };
    return (
      <div>
        <div ref={ref}>
          <Row className='card-body' gutter={[0, { xs: 16, md: 8 }]}>
            <Col xs={24} md={12}>
              <label className='text-header'><Trans>pages.vaccine.chart.dose2.title</Trans></label>
            </Col>
            ...
            <Col xs={24} md={24}>
              <label className='fs14'>
                <Trans>pages.vaccine.chart.dose2.detail</Trans>
              </label>
            </Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(VaccineDose2));
